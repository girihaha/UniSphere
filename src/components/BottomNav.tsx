...
export default function BottomNav({ active, onChange }: BottomNavProps) {
  return (
    <div
      className="fixed bottom-0 z-50 flex justify-center pointer-events-none"
      style={{ left: '50%', transform: 'translateX(-50%)', width: '100%', maxWidth: '430px' }}
    >
      <nav
        ...
        style={{
          ...
          boxShadow: '0 -4px 32px rgba(0,0,0,0.6), 0 8px 32px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.06)',
        }}
      >
            ...
            >
              ...
              >
                ...
                <Icon
                  ...
                  className={`relative z-10 transition-colors duration-200 ${isActive ? 'text-white' : 'text-white/35'}`}
                />
              </div>
              <span
                className={`
